...
import com.cutmeshort.client.auth.Authentication;
import com.cutmeshort.client.auth.HttpBasicAuth;
import com.cutmeshort.client.auth.HttpBearerAuth;
...
import com.cutmeshort.client.util.StringUtil;
...
import com.cutmeshort.client.interceptor.GzipRequestInterceptor;
...
public class ApiClient {
    ...
    protected String basePath = AppConstants.getApiBaseUrl();
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      AppConstants.getApiBaseUrl(),
      "Production server",
    ...
    public ApiClient() {
        ...
        ApiKeyAuth apiKeyAuth = new ApiKeyAuth(AppConstants.AUTH_LOCATION_HEADER, AppConstants.API_KEY_HEADER_NAME);
        apiKeyAuth.setApiKeyPrefix("Bearer");
        authentications.put(AppConstants.AUTH_SCHEME_API_KEY, apiKeyAuth);
    ...
    protected void init() {
        ...
        setUserAgent(AppConstants.DEFAULT_USER_AGENT);
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.cutmeshort.com)
     ...
     * @return a {@link com.cutmeshort.client.ApiClient} object
     */
    ...
    public ApiClient setUserAgent(String userAgent) {
        addDefaultHeader(AppConstants.HEADER_USER_AGENT, userAgent);
        return this;
    }
    ...
    */
     ...
     * @throws com.cutmeshort.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.cutmeshort.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.cutmeshort.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.cutmeshort.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.cutmeshort.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.cutmeshort.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.cutmeshort.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.cutmeshort.client.ApiException If fail to serialize the request body object into a string
     */
